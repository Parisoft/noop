package com.github.parisoft.noop.ui.wizards;
 ...
 * "noop". If a sample multi-page editor (also available
...
public class SampleNewWizard extends Wizard implements INewWizard {
	...
	private void throwCoreException(String message) throws CoreException {
		IStatus status =
			new Status(IStatus.ERROR, "com.github.parisoft.noop.ui", IStatus.OK, message, null);
